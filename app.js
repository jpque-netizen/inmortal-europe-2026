...
{id:"ams",wlat:52.3676,wlon:4.9041,name:"Amsterdam",flag:"🇳🇱",country:"Netherlands",days:"Days 2-3 & 17-18",dates:"Mon Sep 7 – Tue Sep 8\nFri Sep 22 – Sat Sep 23",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,
 ...
 descripcion_dia:[
  ...
  {libre:true,t:`📅 Day 17 — Tue Sep 22`,c:`🇧🇪→🇳🇱 Brussels · Amsterdam ⭐ PERSONAL TOUR`,full:`Breakfast. We head to Amsterdam. Free time for personal activities or optional excursion. Accommodation.`,attrs:[],opc:[[`Volendam & Marken`,`Picturesque fishing villages · wooden houses · traditional costumes`],[`The Hague — Den Haag`,`Seat of the Dutch government · Parliament · UN International Court of Justice`],[`Giethoorn Village`,`The 'Venice of the Netherlands' · no streets, only canals · only if the flight departs after 8:00 pm`]]},
  {t:`📅 Day 18 — Wed Sep 23`,c:`🇳🇱 Amsterdam → ✈️ Mexico City`,full:`Breakfast. At the indicated time, transfer to the airport for the return flight to Mexico City.`,attrs:[],opc:[]}
 ],
 atractivos_itinerario:[
  ...
  ["Volendam & Marken","Picturesque fishing villages · wooden houses · traditional costumes"],
  ["The Hague — Den Haag","Seat of the Dutch government · Parliament · UN International Court of Justice"],
  ["Giethoorn Village","The 'Venice of the Netherlands' · no streets, only canals · only if the flight departs after 8:00 pm"],
 ...
 saludos:{idioma:"Dutch (Nederlands)",nota:"Dutch is the official language. Almost everyone speaks English — but a local greeting makes a great impression!",frases:[
  {cat:"✅ Yes",local:"Ja",pron:"Ya",tip:""},
  {cat:"❌ No",local:"Nee",pron:"Nay",tip:""},
...
{id:"han",wlat:52.3759,wlon:9.732,name:"Hanover",flag:"🇩🇪",country:"Germany",days:"Day 3 (transit)",dates:"Tue Sep 8 (stop on Amsterdam–Berlin route)",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,libre:[],tourPersonal:"",
 ...
 saludos:{idioma:"German (Deutsch)",nota:"Hanoverian German is considered the purest and most neutral German. Any greeting in German is warmly appreciated.",frases:[
  {cat:"✅ Yes",local:"Ja",pron:"Ya",tip:""},
  {cat:"❌ No",local:"Nein",pron:"Nine",tip:""},
...
{id:"ber",wlat:52.52,wlon:13.405,name:"Berlin",flag:"🇩🇪",country:"Germany",days:"Days 3-5",dates:"Tue Sep 8 – Thu Sep 10",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,libre:[],tourPersonal:"",
 ...
 atractivos_itinerario:[
  ...
  ["Potsdam City","Capital of Brandenburg · Sanssouci Palace UNESCO · summer residence of Frederick the Great"],
...
{id:"var",wlat:52.2297,wlon:21.0122,name:"Warsaw",flag:"🇵🇱",country:"Poland",days:"Days 5-6",dates:"Thu Sep 10 – Fri Sep 11",moneda:"Polish Złoty (zł / PLN)",cambio:`$1 USD = ${(1/PLN).toFixed(2)} zł`,libre:[],tourPersonal:"",
 ...
 saludos:{idioma:"Polish (Polski)",nota:"Polish has sounds unfamiliar to English speakers — any attempt at Polish creates enormous goodwill with locals!",frases:[
  {cat:"✅ Yes",local:"Tak",pron:"Tahk",tip:""},
  {cat:"❌ No",local:"Nie",pron:"Nyeh",tip:""},
...
{id:"cra",wlat:50.0647,wlon:19.945,name:"Kraków",flag:"🇵🇱",country:"Poland",days:"Days 6-8",dates:"Fri Sep 11 – Sun Sep 13",moneda:"Polish Złoty (zł / PLN)",cambio:`$1 USD = ${(1/PLN).toFixed(2)} zł`,
 ...
 atractivos_itinerario:[
  ...
  ["Auschwitz-Birkenau Concentration Camp","The largest Nazi complex · deeply moving visit · monument to Holocaust victims"],
  ["Wieliczka Salt Mine","World's oldest operating salt mine · salt-rock chapels · St. Kinga's Chapel · UNESCO"],
...
{id:"pra",wlat:50.0755,wlon:14.4378,name:"Prague",flag:"🇨🇿",country:"Czech Republic",days:"Days 8-10",dates:"Sun Sep 13 – Mon Sep 15",moneda:"Czech Koruna (Kč / CZK)",cambio:`$1 USD = ${(1/CZK).toFixed(1)} Kč`,
 ...
 atractivos_itinerario:[
  ...
  ["Boat ride on the Vltava River","Boat tour · passes under Charles Bridge · views of Prague Castle"],
  ["Karlovy Vary Excursion","Elegant spa town · 12 thermal springs · frequented by royalty and celebrities"],
  ["Czech evening with traditional dinner","Traditional Czech dinner · folk music · typical dances · local wine or beer"],
 ...
 saludos:{idioma:"Czech (Čeština)",nota:"Czech is a Slavic language with stress on the first syllable. Czechs may seem reserved at first — trying their language changes everything!",frases:[
  {cat:"✅ Yes",local:"Ano",pron:"AH-no",tip:""},
  {cat:"❌ No",local:"Ne",pron:"Neh",tip:""},
...
{id:"nur",wlat:49.4521,wlon:11.0767,name:"Nuremberg",flag:"🇩🇪",country:"Germany",days:"Days 10-12",dates:"Mon Sep 15 – Wed Sep 17",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,
 ...
 atractivos_itinerario:[
  ...
  ["Rothenburg ob der Tauber","Germany's best-preserved medieval town · walls · half-timbered houses · Romantic Road"],
  ["Munich City","Capital of Bavaria · Oktoberfest · Marienplatz · New Town Hall · beer culture"],
...
{id:"fra",wlat:50.1109,wlon:8.6821,name:"Frankfurt",flag:"🇩🇪",country:"Germany",days:"Days 12-13",dates:"Wed Sep 17 – Thu Sep 18",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,libre:[],tourPersonal:"",
 ...
 atractivos_itinerario:[
  ...
  ["Evening boat ride on the Main River","Evening boat tour · contrast between the historic Römer and the financial skyline"],
...
{id:"lux",wlat:49.6116,wlon:6.1319,name:"Luxembourg",flag:"🇱🇺",country:"Grand Duchy of Luxembourg",days:"Day 13 (excursion) & 14",dates:"Thu Sep 18 – Fri Sep 19",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,
 ...
 saludos:{idioma:"Luxembourgish (Lëtzebuergesch) · French · German",nota:"Luxembourg has 3 official languages: Luxembourgish, French and German. Everyone speaks all three. French is most practical — but a Luxembourgish greeting is truly special!",frases:[
  {cat:"✅ Yes",local:"Jo",pron:"Yo",tip:""},
  {cat:"❌ No",local:"Neen",pron:"Nayn",tip:""},
...
{id:"met",wlat:49.1193,wlon:6.1757,name:"Metz",flag:"🇫🇷",country:"France (Lorraine)",days:"Days 13-15 (base city)",dates:"Thu Sep 18 – Sat Sep 20",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,
 ...
 atractivos_itinerario:[
  ...
  ["Luxembourg City","Capital of the Grand Duchy · UNESCO Casemates · one of Europe's financial and political centers"],
  ["Schengen City","Where the Schengen Agreement (1985) was signed, abolishing border controls in Europe"],
  ...
  ["Strasbourg","Gothic cathedral · seat of the European Parliament · excursion together with Colmar"],
  ["Colmar","Fairytale architecture · 'Little Venice' quarter · excursion together with Strasbourg"],
 ...
 saludos:{idioma:"French (Français) · Lorraine",nota:"Metz is in the Lorraine region, bordering Germany and Luxembourg. French is the daily language — Lorrainers really appreciate the effort to speak it!",frases:[
  {cat:"✅ Yes",local:"Oui",pron:"Wee",tip:""},
  {cat:"❌ No",local:"Non",pron:"Nohn",tip:""},
...
{id:"bru",wlat:50.8503,wlon:4.3517,name:"Brussels",flag:"🇧🇪",country:"Belgium",days:"Days 15-17",dates:"Sat Sep 20 – Mon Sep 22",moneda:"Euro (€)",cambio:`1 € = $${EUR.toFixed(3)} USD`,
 ...
 atractivos_itinerario:[
  ...
  ["Bruges and Ghent","Bruges: 'Venice of the North' · medieval canals · Flemish architecture. Ghent: medieval castle · vibrant city"],
 ...
 saludos:{idioma:"French (Français) · Dutch (Nederlands)",nota:"Brussels is officially bilingual — French is more commonly used. Belgians are famous for being kind and tolerant with foreigners who try their language.",frases:[
  {cat:"✅ Yes",local:"Oui / Ja",pron:"Wee / Ya",tip:""},
  {cat:"❌ No",local:"Non / Nee",pron:"Nohn / Nay",tip:""},
 ...
 if(curSub==='itinerario'){
  ...
  if(c.descripcion_dia&&c.descripcion_dia.length){
   h+=c.descripcion_dia.map(d=>{
    ...
    b+=`<div class="day-block-title">${d.t}${d.libre?' <span class="libre-badge">🟢 FREE DAY</span>':''}</div>`;
    b+=`<div class="day-block-city">${d.c}</div>`;
    b+=`<div class="day-block-full">${d.full}</div>`;
    if(d.attrs&&d.attrs.length){
     b+=`<div class="day-block-label">Attractions included in the tour</div>`;
    ...
    if(d.opc&&d.opc.length){
     b+=`<div class="day-block-label opc-label">🎫 Optional tours · not included in the base tour</div>`;
...
function renderNotes(cityId,section){
  ...
  h+=notes.map((n,i)=>`
   <div class="note-row" id="note-row-${cityId}-${section}-${i}">
    <div class="note-actions">
     <button class="note-edit" onclick="editNote('${cityId}','${section}',${i})" title="Edit">✏️</button>
     <button class="note-del" onclick="delNote('${cityId}','${section}',${i})" title="Delete">🗑</button>
    </div>
 ...
 h+=`<div class="note-add">
  <textarea id="note-input-${cityId}-${section}" placeholder="Write a note (restaurant tip, visited place, etc.)" rows="1" oninput="autoGrow(this)"></textarea>
...
async function viewPhoto(id){
 ...
 req.onsuccess=()=>{
  ...
  overlay.innerHTML=`<div class="photo-overlay-inner"><img src="${p.data}" alt="">${p.caption?`<div class="photo-overlay-cap">🏷️ ${escapeHtml(p.caption)}</div>`:''}<div class="photo-overlay-info">📅 ${p.date}</div><button class="photo-overlay-close" onclick="this.parentElement.parentElement.remove()">✕ Close</button></div>`;
 ...
 req.onsuccess=async()=>{
  ...
  overlay.innerHTML=`
   <div class="doc-overlay-bar">
    ...
    <button class="doc-overlay-open" id="doc-open-full" title="Open full">⤢</button>
    <button class="doc-overlay-close" onclick="this.closest('.doc-overlay').remove()">✕</button>
   </div>
   <div class="doc-overlay-pages" id="doc-pages"><div class="doc-loading">Loading document…</div></div>`;
  document.body.appendChild(overlay);
  ...
  try{
   ...
   cont.innerHTML=`<div class="doc-loading">Could not display the PDF here.<br>Use the "⤢" button to open it in the browser.<br><br><iframe class="doc-overlay-frame" src="${d.data}"></iframe></div>`;
  }
 };
}
...
// HOME itinerary
const itin=[
 {d:"1",cityIdx:0,wd:"Sun",dt:"Sep 6",c:"✈️ Mexico City → Amsterdam",n:"Transatlantic flight · overnight on board",tipo:"normal",
 ...
 {d:"2",cityIdx:0,wd:"Mon",dt:"Sep 7",c:"🇳🇱 Amsterdam",n:"Arrival · reception · panoramic city tour",tipo:"normal",
 ...
 {d:"3",cityIdx:2,wd:"Tue",dt:"Sep 8",c:"🇳🇱→🇩🇪 Amsterdam · Hanover · Berlin",n:"Breakfast · stop in Hanover · arrival Berlin",tipo:"normal",
 ...
 {d:"4",cityIdx:2,wd:"Wed",dt:"Sep 9",c:"🇩🇪 Berlin",n:"Panoramic tour · opt. Potsdam",tipo:"normal",
 ...
 {d:"5",cityIdx:3,wd:"Thu",dt:"Sep 10",c:"🇩🇪→🇵🇱 Berlin · Warsaw",n:"Breakfast · journey · UNESCO Old Town tour",tipo:"normal",
 ...
 {d:"6",cityIdx:4,wd:"Fri",dt:"Sep 11",c:"🇵🇱 Warsaw → Kraków",n:"Breakfast · journey · Kraków panoramic tour",tipo:"normal",
 ...
 {d:"7",cityIdx:4,wd:"Sat",dt:"Sep 12",c:"🇵🇱 Kraków ★ FREE DAY",n:"Opt. Auschwitz · Wieliczka · or personal tour",tipo:"libre",
 ...
 {d:"8",cityIdx:5,wd:"Sun",dt:"Sep 13",c:"🇵🇱→🇨🇿 Kraków · Prague",n:"Breakfast · journey · Prague panoramic tour",tipo:"normal",
 ...
 {d:"9",cityIdx:5,wd:"Mon",dt:"Sep 14",c:"🇨🇿 Prague ★ FREE DAY",n:"Opt. Vltava Cruise · Karlovy Vary/Czech Night · or personal",tipo:"libre",
  full:`Breakfast. Free day for personal activities or an optional excursion. Accommodation.`,
  opcionales:["Vltava River Cruise","Karlovy Vary Excursion","Czech evening with traditional dinner"]},
 {d:"10",cityIdx:6,wd:"Tue",dt:"Sep 15",c:"🇨🇿→🇩🇪 Prague · Nuremberg",n:"Breakfast · journey · Nuremberg city tour",tipo:"normal",
 ...
 {d:"11",cityIdx:6,wd:"Wed",dt:"Sep 16",c:"🇩🇪 Nuremberg ★ FREE DAY",n:"Opt. Rothenburg · Munich · or personal tour",tipo:"libre",
  full:`Breakfast. Free day for personal activities or an optional excursion. Accommodation.`,
  opcionales:["Rothenburg ob der Tauber","Munich City"]},
 {d:"12",cityIdx:7,wd:"Thu",dt:"Sep 17",c:"🇩🇪 Nuremberg → Frankfurt",n:"Breakfast · journey · Frankfurt city visit",tipo:"normal",
 ...
 {d:"13",cityIdx:9,wd:"Fri",dt:"Sep 18",c:"🇩🇪→🇱🇺🇫🇷 Frankfurt · Luxembourg · Metz",n:"Breakfast · Luxembourg stop (opt.) · Metz base city",tipo:"libre",
 ...
 {d:"14",cityIdx:9,wd:"Sat",dt:"Sep 19",c:"🇫🇷 Metz / Thionville ★ FREE DAY",n:"Opt. Strasbourg/Colmar · or Metz on your own",tipo:"libre",
  full:`Breakfast. Free day for personal activities or an optional excursion. Accommodation.`,
 ...
 {d:"17",cityIdx:0,wd:"Tue",dt:"Sep 22",c:"🇧🇪→🇳🇱 Brussels · Amsterdam ⭐ PERSONAL TOUR",n:"If you skip the excursion: free Amsterdam day → Rijksmuseum, Jordaan, canals",tipo:"tp",
 ...
 {d:"18",cityIdx:0,wd:"Wed",dt:"Sep 23",c:"🇳🇱 Amsterdam → ✈️ Mexico City",n:"Breakfast · airport transfer · return flight",tipo:"normal",
...
document.getElementById('quick-itinerary').innerHTML=itin.map((i,idx)=>{
 return `<div class="irow irow-link" data-day="${idx}" id="irow-${idx}" role="button" tabindex="0" onclick="goToCity(${i.cityIdx})">
  ...
  <div style="flex:1;min-width:0">
   <div class="icity${i.tipo==='libre'?' libre':i.tipo==='tp'?' tp':''}">${i.c}${(i.tipo==='libre'||i.tipo==='tp')?' <span class="irow-libre">🟢 FREE DAY</span>':''}<span class="irow-arrow">›</span></div>
...
document.getElementById('tp-home-box').innerHTML=`<div class="tph">7 opportunities identified in the itinerary</div>`+[
 {d:"Day 7 · Sat Sep 12",c:"Kraków",n:"Skip Auschwitz and Wieliczka? Kazimierz Quarter + Main Market Square at your own pace."},
 ...
 {d:"Day 13 · Fri Sep 18",c:"Metz / Luxembourg",n:"Skip the Luxembourg or Schengen excursion? Saint-Étienne Cathedral + Centre Pompidou-Metz at your own pace."},
 {d:"Day 14 · Sat Sep 19",c:"Metz",n:"No excursions? Saint-Étienne Cathedral + Centre Pompidou-Metz + Temple Quarter."},
 {d:"Day 16 · Mon Sep 21",c:"Brussels",n:"Skip Bruges and Ghent? Atomium + Marolles district + Belgian waffles and beer tasting."},
 {d:"Day 17 · Tue Sep 22 ⭐",c:"Amsterdam (recommended)",n:"Skip the excursion? Amsterdam free for the Rijksmuseum, Jordaan neighborhood and canals at leisure."},
...
function abrirEtiqueta(id,ownerId){
 ...
 openPhotoDB().then(db=>{
  ...
  req.onsuccess=()=>{
   ...
   let chips='';
   if(lugares.length){
    chips='<div class="tag-sec">Itinerary attractions</div><div class="tag-chips">'
   ...
   ov.innerHTML=`<div class="tag-panel">
     <div class="tag-head">🏷️ Photo label</div>
     ${chips}
     <div class="tag-sec">Write your own</div>
     <input type="text" id="tag-input" maxlength="40" placeholder="e.g. Charles Bridge at sunset" value="${escapeHtml(p.caption||'')}" oninput="document.getElementById('tag-count').textContent=this.value.length+'/40'">
     <div class="tag-count" id="tag-count">${(p.caption||'').length}/40</div>
     <div class="tag-btns">
      <button class="tag-save" onclick="guardarEtiqueta(${id})">💾 Save</button>
      <button class="tag-cancel" onclick="document.getElementById('tag-editor').remove()">✕ Cancel</button>
     </div>
    </div>`;
